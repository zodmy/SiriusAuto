  ...
  return (
    <footer className='bg-gray-800 text-white'>
      <div className='max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8'>
        <div className='flex flex-col md:flex-row md:justify-between md:items-center text-sm space-y-2 md:space-y-0'>
          ...
          <div className='text-gray-400 text-sm mt-4 md:mt-0'>© 2024 Sirius Auto. Всі права захищені.</div>
        </div>
      </div>
    </footer>
  );
