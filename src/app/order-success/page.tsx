    ...
    <main className='container mx-auto px-4 py-16'>
      <div className='max-w-2xl mx-auto text-center'>
        <div className='bg-white rounded-lg shadow-md p-8'>
          ...
          <p className='text-lg text-gray-600 mb-6'>Дякуємо за ваше замовлення! Ми розпочнемо обробку найближчим часом.</p>{' '}
          {orderId && (
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <button onClick={() => router.push('/')} className='bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-md font-medium cursor-pointer'>
              Продовжити покупки
            </button>
